                ...
                <div className="project-details-content"> 
                    ...
                    <div className="row g-4 mt-4">
                        <div className="col-md-6">
                            ...
                            <Image src="/assets/img/case-studies/details-1.jpg" alt="img" width={681} height={324}   />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="details-image">
                            <Image src="/assets/img/case-studies/details-2.jpg" alt="img" width={681} height={324}   />
                            </div>
                        </div>
                    </div>
                </div>
