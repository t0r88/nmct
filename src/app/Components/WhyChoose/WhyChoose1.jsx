                ...
                <div className="team-wrapper">
                    <div className="row g-4">
                        <div className="col-lg-6">
                            ...
                            <Image src={chooseContent.img} alt="img" className="wow img-custom-anim-left" width={311} height={511}   />
                                <div className="shape-image">
                                <Image src="/assets/img/team/shape-img.png" alt="img" width={548} height={511}   />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="team-content">
                                ...
                                <div className="main-button wow fadeInUp" data-wow-delay=".5s">
                                    <Link href="/team"> <span className="theme-btn"> EXPLORE MORE </span><span className="arrow-btn"><i className="bi bi-arrow-right"></i></span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
