                ...
                <div className="row g-4">
                    <div className="col-lg-6">
                        <div className="team-image-2">
                             <Image src={chooseContent.img} alt="img" className="wow img-custom-anim-left" width={391} height={539}   />
                            <div className="client-shape float-bob-x">
                            <Image src="/assets/img/team/client-shape.png" alt="img" width={304} height={173}   />
                            </div>
                            <div className="box-shape float-bob-y">
                            <Image src="/assets/img/team/box-shape.png" alt="img" width={236} height={120}   />
                            </div>
                            <a href="team.html" className="circle-button">
                            <i className="bi bi-arrow-up-right"></i>
                                <span className="text-circle">
                                <Image src="/assets/img/about/white-text.png" alt="img" width={99} height={99}   />
                                </span>
                            </a>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="team-content">
                            ...
                            <div className="main-button wow fadeInUp" data-wow-delay=".5s">
                                <Link href="/team"> <span className="theme-btn"> EXPLORE MORE </span><span className="arrow-btn"> <i className="bi bi-arrow-up-right"></i></span></Link>
                            </div>
                        </div>
                    </div>
                </div>
