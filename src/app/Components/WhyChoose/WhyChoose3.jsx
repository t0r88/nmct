                ...
                <div className="about-wrapper-2">
                    <div className="row g-4">
                        <div className="col-lg-6">
                            ...
                            <Image src="/assets/img/choose-us.png" alt="img" width={681} height={542} className="w-100"   />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                <div className="main-button wow fadeInUp" data-wow-delay=".3s">
                                    <Link href="/about"> <span className="theme-btn">EXPLORE MORE </span><span className="arrow-btn"> <i className="bi bi-arrow-up-right"></i></span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="cta-marketing-2 section-padding pb-0">
                <div className="container">
                    <div className="cta-marketing-wrapper">
                        ...
                        <Image src="/assets/img/cta-marketing.png" alt="img" width={357} height={284}   />
                        </div>
                    </div>
                </div>
            </div>
