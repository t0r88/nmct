        ...
        <div className="container">
          <div className="cs_main_header_in">
            ...
            <Link className="cs_site_branding" href="/">
                <Image src="/assets/img/logo/png1.png" alt="img" width={66} height={66}   />
              </Link>
              </div>
            ...
            <div className="cs_main_header_right">
              ...
              <a onClick={() => setSearchToggle(!searchToggle)} className="search-trigger search-icon"><i className="bi bi-search"></i></a>
                ...
                <Link href="/contact">
                <span className="theme-btn"> Холбоо барих </span><span className="arrow-btn"><i className="bi bi-arrow-right"></i></span></Link>
                  </div>
