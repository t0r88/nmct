                        ...
                        <div className="col-12 col-lg-8">
                            <div className="news-post-details">
                                <div className="single-news-post">
                                    ...
                                    <Image src="/assets/img/news/details-1.jpg" alt="img" width={916} height={547}   />
                                    </div>
                                    <div className="post-content">
                                        ...
                                        <div className="row g-4">
                                            <div className="col-lg-6">
                                                ...
                                                <Image src="/assets/img/news/details-2.jpg" alt="img" width={446} height={324}   />
                                                </div>
                                            </div>
                                            <div className="col-lg-6">
                                                <div className="details-image">
                                                <Image src="/assets/img/news/details-3.jpg" alt="img" width={446} height={324}   />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="comments-area">
                                    ...
                                    <div className="blog-single-comment d-flex gap-4 pt-4 pb-5">
                                        <div className="image">
                                        <Image src="/assets/img/news/comment-1.png" alt="img" width={96} height={96}   />
                                        </div>
